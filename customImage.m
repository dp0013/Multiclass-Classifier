function image = customImage(fileName, cropPercentage=0, rotStep=0)
%CUSTOMIMAGE takes in a user's handwritten digit, displays reduced image,
%and converts for digit classification

% NOTE:  MUST have 'image' pkg loaded first!  
%
% octave:1>  pkg load image
%
% ===========   Sample Usage  ===========
%
% octave:1>  vectorImage = customImage('5.jpg', cropPercentage=0, rotStep=0);
% octave:2>  predict(Theta1, Theta2, vectorImage);
% ans = 5
%
% ========================================
...
image = reshape(contrastedImage, 1, newSize(1)*newSize(2));
end